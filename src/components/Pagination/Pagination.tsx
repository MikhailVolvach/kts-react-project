...
const fetchPageNumbers = (totalPages: number, currentPage: number, pageNeighbours: number = 1) => {
    ...
    <div className={style.pagination}>
      <div className={style.pagination__container}>
        {pages.map((page, index) => {
          ...
          return (
            <Button key={index} onClick={handleClick} className={classNames(style.pagination__item, currentPage === page && style.pagination__item_active)}>
              {page}
            </Button>
          )
        })}
